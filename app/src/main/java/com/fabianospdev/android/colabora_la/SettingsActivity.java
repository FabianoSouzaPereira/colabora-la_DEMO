...
public class SettingsActivity extends AppCompatActivity {
  ...
  protected void onCreate( android.os.Bundle savedInstanceState ) {
    ...
    setContentView( com.fabianospdev.android.colabora_la.R.layout.settings_activity );
    getSupportFragmentManager().beginTransaction().replace( com.fabianospdev.android.colabora_la.R.id.settings, new com.fabianospdev.android.colabora_la.SettingsActivity.SettingsFragment() ).commit();
